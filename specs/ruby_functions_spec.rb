...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_sphere_5()
    volume_of_sphere = volume_of_sphere(5.0)
    assert_equal(524, volume_of_sphere)
  end

  def test_volume_of_sphere_10()
    volume_of_sphere = volume_of_sphere(10.0)
    assert_equal(4189, volume_of_sphere)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius_32()
    temp_in_f = fahrenheit_to_celsius(32.0)
    assert_equal(0, temp_in_f)
  end

  def test_fahrenheit_to_celsius_50()
    temp_in_f = fahrenheit_to_celsius(50.0)
    assert_equal(10, temp_in_f)
  end
